...
![Discord](./docs/images/discord.png) <!-- 실제 캡처 이미지 추가 예정 -->

---

### **📑 Notion (작업 관리 & 문서화)**

- **메인 페이지**: 프로젝트 개요, 일정, 진행률을 한눈에 확인 가능
- **작업 내용 관리**: 기능별 태스크 기록, 담당자 지정, 마감 기한 관리
- **회의 기록 및 의사결정 로그** 작성으로 프로젝트 진행 투명성 확보

![Notion](./docs/images/notion.png) <!-- 실제 캡처 이미지 추가 예정 -->
...
![GitHub](./docs/images/github.png) <!-- 실제 캡처 이미지 추가 예정 -->
